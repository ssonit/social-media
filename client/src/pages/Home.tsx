...
const Home: FC = () => {
  ...
  return (
    <MainLayout>
      ...
      <div className='min-h-screen mb-[50px] grid grid-cols-1 lg:grid-cols-6 lg:gap-2'>
        <div></div>
        <div className='col-span-3 lg:mt-6'>
        ...
        <div className='relative hidden col-span-2 lg:block'>
